...
function preload() {
    ...
    bottomTextCA = loafImage('img/CAfiresBottomText.png');
    mainTextCA = loafImage('img/CAfiresMainText.png');
    topTextCA = loafImage('img/CAfiresTopText.png');

    bottomMainTextCap = loafImage('img/CapBotttomMainText.png');
    //mainTextCap = loafImage('img/capMainText.png');
    topTextCap = loafImage('img/capTopText.png');

    smokeBG = loafImage('img/smokeBG.png');
...
function mainText() {
    image(mainTextCA, marginS, marginT + rectY - mainTextCA.height);
    /*
    textSize(60);
    //textFont('akkordeon');
    textStyle(NORMAL);
...
function bottomText() {
    image(bottomTextCA, width - bottomTextCA.width, height - bottomTextCA.height);
    /*
...
function mainTextCap() {
    image(botttomMainTextCap, 0, height - bottomMainTextCap.height);
    /*
    textSize(40);
    fill('black');
    noStroke();
